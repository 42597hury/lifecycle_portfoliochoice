...
def diagnose_newton_failures_retirement(
    ...
    Returns:
        corner_focs : (N_state, 6)
        failure_reasons : (N_state, 6)
    """
    n_z = len(z_grid)
        ...
        for z_i in range(n_z):
            ...
            for s_i in range(n_savings):
                ...
                if exit_code == EC_NEWTON_FAIL:
                    failure_reasons[i_s, 3] += 1
                    failure_reasons[i_s, 2] += 1
                    ...
                    if not has_sb and not has_bb and not has_stockbond:
                        failure_reasons[i_s, 0] += 1
                    else:
                        failure_reasons[i_s, 5] += 1
