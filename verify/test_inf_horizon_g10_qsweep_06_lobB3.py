"""IH g=10 quad sweep RUN 6: Lobatto on xb return axis at Z=3.0.

n_state_quad_nodes=(3,3,5)
n_ret_nodes_1d=(4,4)
state_lobatto_Z=None
ret_lobatto_Z=(None, 3.0)   Lobatto-tail on xb at +/-3 sigma

Tests whether prescribed-tail anchoring on xb (the bond return innovation)
refines residual integration vs GH.
"""
import os, time
import numpy as np
