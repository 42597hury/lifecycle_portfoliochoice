"""IH g=10 quad sweep RUN 4: reduce ret-quad (4,4) -> (3,3).

n_state_quad_nodes=(3,3,5)
n_ret_nodes_1d=(3,3)         REDUCED ret-quad
state_lobatto_Z=None
ret_lobatto_Z=None

Tests return-quad saturation. Prior audits showed (3,3) is saturated;
confirm at the new IH baseline that (4,4) -> (3,3) doesn't move policy.
"""
import os, time
import numpy as np
