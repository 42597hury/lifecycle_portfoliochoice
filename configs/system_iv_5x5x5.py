"""Dev config: full lifecycle on a 5x5x5 state grid.
...
`configs/_canonical.py`; overrides only `state_grid_sizes`.
...
disc_config_template = CANONICAL_DISC._replace(state_grid_sizes=(5, 5, 5))
