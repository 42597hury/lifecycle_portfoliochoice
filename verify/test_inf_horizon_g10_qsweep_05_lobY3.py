"""IH g=10 quad sweep RUN 5: Lobatto on y_1 state axis at Z=3.0.

n_state_quad_nodes=(3,3,5)
n_ret_nodes_1d=(4,4)
state_lobatto_Z=(None, None, 3.0)   Lobatto-tail on y_1 at +/-3 sigma
ret_lobatto_Z=None

Tests whether prescribed-tail anchoring on y_1 refines integration vs GH.
"""
import os, time
import numpy as np
