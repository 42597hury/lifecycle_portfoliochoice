"""IH g=10 quad sweep RUN 2: lift y_1 state-quad 5 -> 7.

n_state_quad_nodes=(3,3,7)  bigger K-bump on y_1
n_ret_nodes_1d=(4,4)
state_lobatto_Z=None
ret_lobatto_Z=None

Tests if K=5 on y_1 was under-resolved.
"""
import os, time
import numpy as np
...
disc = DiscretizationConfig(
    ...
    n_state_quad_nodes=(3, 3, 7), state_lobatto_Z=None,
)
