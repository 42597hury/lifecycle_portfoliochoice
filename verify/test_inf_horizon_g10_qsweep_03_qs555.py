"""IH g=10 quad sweep RUN 3: isotropic state-quad (5,5,5).

n_state_quad_nodes=(5,5,5)  isotropic — refines cape/spr too
n_ret_nodes_1d=(4,4)
state_lobatto_Z=None
ret_lobatto_Z=None

Tests whether cape/spr quad refinement (which prior audits suggested
was saturated) actually moves IH policy at this scale.
"""
import os, time
import numpy as np
...
disc = DiscretizationConfig(
    ...
    n_state_quad_nodes=(5, 5, 5), state_lobatto_Z=None,
)
...
IH_TOL = 1e-5; IH_MAX_ITER = 200; IH_DAMPING = 0.5; TERM_PREMIUM_THETA = 0.0
